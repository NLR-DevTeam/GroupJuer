package cn.whitrayhb.groupjuer;
...
public final class GroupJuerMain extends JavaPlugin {
    public static final GroupJuerMain INSTANCE = new GroupJuerMain();
    private GroupJuerMain() {
